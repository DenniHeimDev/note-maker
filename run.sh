...
HOST_INPUT_PATH_DEFAULT="${HOST_INPUT_PATH:-${CONFIG_INPUT_PATH:-$HOME/Downloads}}"
HOST_OUTPUT_PATH_DEFAULT="${HOST_OUTPUT_PATH:-${CONFIG_OUTPUT_PATH:-$HOME/Documents/note-maker}}"
